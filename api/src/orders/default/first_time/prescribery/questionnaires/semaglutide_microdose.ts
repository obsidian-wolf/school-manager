export default {
	mja3: [
		...
		{
			entry_id: '6101',
			notes: 'What is your primary reason for seeking GLP-1 therapy for longevity (check all that apply)?',
			key: 'glp1-longevity',
		},
		{
			entry_id: '6102',
			notes: 'Have you experienced any specific symptoms of aging, such as weight gain, decreased energy levels, or changes in metabolism, that you believe GLP-1 medications could help with?&nbsp;',
			key: 'glp1-symptoms',
		},
		{
			entry_id: '6103',
			notes: 'Are you aware that microdosing GLP-1 for longevity is an off-label use, and the scientific research on its long-term benefits for anti-aging is still in early stages?&nbsp;',
			key: 'off-label-use',
		},
		{
			entry_id: '5002',
