...
export const downloadFile = (id: string, signal?: AbortSignal) => {
    return customInstance<string>({ url: `/embedding/download/${id}`, method: 'GET', signal });
};
...
export function useGetFile<TData = Awaited<ReturnType<typeof getFile>>, TError = unknown>(
    ...
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFile>>, TError, TData>> &
            Pick<
                DefinedInitialDataOptions<Awaited<ReturnType<typeof getFile>>, TError, TData>,
                'initialData'
            >;
    },
): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey };
export function useGetFile<TData = Awaited<ReturnType<typeof getFile>>, TError = unknown>(
    ...
    options?: {
        query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFile>>, TError, TData>> &
            Pick<
                UndefinedInitialDataOptions<Awaited<ReturnType<typeof getFile>>, TError, TData>,
                'initialData'
            >;
    },
): UseQueryResult<TData, TError> & { queryKey: QueryKey };
 ...
 * @summary Split file text into chunks
 */
export const splitFileText = (id: string) => {
    return customInstance<string[]>({ url: `/embedding/${id}/split`, method: 'POST' });
};

export const getSplitFileTextMutationOptions = <TError = unknown, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof splitFileText>>,
        TError,
        { id: string },
        TContext
    >;
...
> => {
    ...
    > = (props) => {
        ...
        return splitFileText(id);
    };

    return { mutationFn, ...mutationOptions };
};

export type SplitFileTextMutationResult = NonNullable<Awaited<ReturnType<typeof splitFileText>>>;

export type SplitFileTextMutationError = unknown;

/**
 * @summary Split file text into chunks
 */
export const useSplitFileText = <TError = unknown, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof splitFileText>>,
        TError,
        { id: string },
    ...
    TContext
> => {
    const mutationOptions = getSplitFileTextMutationOptions(options);
...
/**
 * Summarize file text
 * @summary Summarize file text
 */
export const summarize = (id: string, params?: SummarizeParams) => {
    return customInstance<string>({ url: `/embedding/${id}/summarize`, method: 'POST', params });
};

export const getSummarizeMutationOptions = <TError = unknown, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
...
export type SummarizeMutationError = unknown;

/**
 * @summary Summarize file text
 */
export const useSummarize = <TError = unknown, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof summarize>>,
        TError,
        { id: string; params?: SummarizeParams },
    ...
    TContext
> => {
    const mutationOptions = getSummarizeMutationOptions(options);
...
export const convertPdfToImage = (
    ...
    return customInstance<ConvertPdfToImage200>({
