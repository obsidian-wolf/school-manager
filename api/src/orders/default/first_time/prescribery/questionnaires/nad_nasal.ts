export default {
	mty3: [
		...
		{
			entry_id: 'checkbox-group-1726431618404',
			notes: 'What is your main reason for seeking NAD therapy? (Mark all that apply)&nbsp;',
			key: undefined,
		},
		{
			entry_id: 'radio-group-1726431939667',
			notes: 'Have you used NAD therapy in the past?',
			key: undefined,
		},
		{
			entry_id: 'text-1726432083154',
			notes: 'If yes, what was your experience?&nbsp;',
			key: undefined,
		},
		{
			entry_id: 'radio-group-1717214273504',
			notes: 'Do you have any known allergies to NAD+ or any of its components?&nbsp;',
			key: 'allergies-nad',
		},
		{
			entry_id: 'radio-group-1717214396393',
			notes: 'Have you experienced any allergic reactions to nasal sprays or medications in the past?&nbsp;',
		...
		{
			entry_id: '5792',
			notes: 'Do you have any chronic respiratory disorders, such as asthma or chronic obstructive pulmonary disease (COPD)?',
			key: 'copd',
		},
		{
			entry_id: '5793',
			notes: 'Do you have any current nasal infections, sinusitis, or nasal congestion?',
			key: 'nasal-infections',
		},
		{
			entry_id: 'radio-group-1717214522433',
			notes: 'Have you been diagnosed with any autoimmune diseases, such as lupus or rheumatoid arthritis?&nbsp;',
			key: 'autoimmune',
		},
		{
			entry_id: 'radio-group-1717214669653',
			notes: 'Do you have any history of cardiovascular diseases, such as heart disease, hypertension, or arrhythmias?&nbsp;',
		...
		},
		{
			...
			notes: 'Are you taking any medications that might interact with NAD+ (example: chemotherapy drugs, immunosuppressants)?&nbsp;',
			key: 'medications-nad',
		},
		{
